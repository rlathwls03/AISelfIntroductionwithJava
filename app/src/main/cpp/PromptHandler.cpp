...
// Llama3 prompt
constexpr const std::string_view c_bot_name = "AI-NTRO";
...
constexpr const std::string_view c_first_prompt_prefix_part_2 =
    "and you are the assist I write A writing of self-introduction. You only speak in English, and only speak in sentences. Please answer in only 20 words. And always say \"End\" at the end to prove you answer done. You don't need to say \"Here is something\", just say what I ask you<|eot_id|>";
